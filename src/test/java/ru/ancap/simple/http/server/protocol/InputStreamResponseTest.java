...
import ru.ancap.simple.http.server.util.FileUtil;
...
public class InputStreamResponseTest extends TestCase implements ResponseSender
{
    ...
    String responseString = output.toString();
		RegexTest.assertSubString("Content-Length: 100000", responseString);
	...
	public void testWithLargerFile() throws Exception
	{
		...
		response.readyToSend(this);
    String responseString = output.toString();
		RegexTest.assertSubString("Content-Length: 10000000", responseString);
	...
	public void _testWithReallyBigFile() throws Exception
	{
		...
		response.readyToSend(this);
    String responseString = output.toString();
		RegexTest.assertSubString("Content-Length: 1000000000", responseString);
